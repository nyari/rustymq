...
fn simple_pub_sub_tcp_test() {
    let mut subscriber1 = model::pubsub::SubscriberSocket::new(transport::network::tcp::InitiatorTransport::new());
    let mut subscriber2 = model::pubsub::SubscriberSocket::new(transport::network::tcp::InitiatorTransport::new());
    let mut publisher1 = model::pubsub::PublisherSocket::new(transport::network::tcp::AcceptorTransport::new());
    let mut publisher2 = model::pubsub::PublisherSocket::new(transport::network::tcp::AcceptorTransport::new());
